...
function loadStarSurfaceTextures() {
  if (sunTexture === undefined) {
    sunTexture = new THREE.TextureLoader().load("images/textures/sun_surface.png", undefined, setLoadMessage("Igniting solar plasma"));
    sunTexture.anisotropy = maxAniso;
    sunTexture.wrapS = sunTexture.wrapT = THREE.RepeatWrapping;
  }

  if (sunColorLookupTexture === undefined) {
    sunColorLookupTexture = new THREE.TextureLoader().load("images/textures/star_colorshift.png");
  }

  if (solarflareTexture === undefined) {
    solarflareTexture = new THREE.TextureLoader().load("images/textures/solarflare.png", undefined, setLoadMessage("Distributing solar flares"));
  }

  if (sunHaloTexture === undefined) {
    sunHaloTexture = new THREE.TextureLoader().load("images/textures/sun_halo.png", undefined, setLoadMessage("Calculating coronal mass"));
  }

  if (sunHaloColorTexture === undefined) {
    sunHaloColorTexture = new THREE.TextureLoader().load("images/textures/halo_colorshift.png");
  }

  if (sunCoronaTexture === undefined) {
    sunCoronaTexture = new THREE.TextureLoader().load("images/textures/corona.png", undefined, setLoadMessage("Projecting coronal ejecta"));
  }
}
